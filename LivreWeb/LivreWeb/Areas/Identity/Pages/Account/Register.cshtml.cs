...
namespace LivreWeb.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [ValidateNever]
            public IEnumerable<SelectListItem> roleSelect { get; set; }
        }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                roleSelect = _roleManager.Roles.Select(x => new SelectListItem
                {
                    Text = x.Name,
                    Value = x.Name,
                })
